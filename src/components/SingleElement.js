...
const SingleElement = ({searchedElements}) => {
    const onBack = () => {
      ...
      return (
        ...
        <h2 className="text-5xl text-white py-6">{searchedElements[0].name}&nbsp;&#40;{searchedElements[0].symbol}&#41;</h2>
        </div>
        <div className="flex h-screen items-center justify-items-stretch">
        <table className="table-auto w-full uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-gray-700 px-6 py-6 shadow-lg">
    <thead>
      <tr>
    ...
    <tbody>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <td className="text-xl px-2 py-2">{searchedElements[0].atomicNumber}</td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">Atomic Mass</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].atomicMass}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">Boiling Point in Celsius</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].boilingPoint - 273} </td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">Density</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].density}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">Bonding Type</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].bondingType}</td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">Electron Affinity</td>
        <td className="text-xl px-2 py-2" >{searchedElements[0].electronAffinity}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">Electronegativity</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].electronegativity}</td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">Group</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].groupBlock}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">Ionization Energy</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].ionizationEnergy}</td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">Melting Point in Celsius</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].meltingPoint - 273}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">State at Room Temperature</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].standardState}</td>
      </tr>
      <tr class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <td className="text-xl px-2 py-2">van De Waal's Radius</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].vanDelWaalsRadius}</td>
      </tr>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        <td className="text-xl px-2 py-2">Year Discovered</td>
        <td className="text-xl px-2 py-2">{searchedElements[0].yearDiscovered}</td>
      </tr>
    </tbody>
  </table>
